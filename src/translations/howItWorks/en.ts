export const howItWorksTranslations = {
  overview: {
    hero: {
      ...
      subtitle: "Simple, seamless cardiac monitoring",
      description: "From prescription to results, SKIIN makes cardiac monitoring effortless for both patients and providers.",
      cta: "Get Started"
    }
  },
  process: {
    hero: {
      title: "The SKIIN Process",
      subtitle: "From prescription to results in 5 simple steps",
      description: "Our streamlined process ensures patients get the monitoring they need with minimal hassle.",
    ...
    physicianView: "Physician View",
    details: "Details",
    insuranceModels: {
      title: "Insurance Coverage Pathways",
      subtitle: "SKIIN works with all Swiss insurance models",
      standard: {
    ...
    whySimple: {
      title: "Why SKIIN is So Simple",
      items: [
        "No wires or electrodes to attach",
        "No lifestyle restrictions during monitoring",
        "No daily diary required (optional symptom logging)",
        "No technician visits needed",
        "No special skin preparation"
      ]
    },
    getStarted: {
      title: "Ready to Start?",
      description: "If you have symptoms or risk factors for heart rhythm issues, SKIIN monitoring could provide the answers you need.",
