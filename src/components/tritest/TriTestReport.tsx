  ...
  return (
    <div className="mt-6">
      <Button
        ...
        className="w-full justify-between bg-gray-50 hover:bg-gray-100 border text-left"
      >
        <span className="font-medium text-blue-600">{title}</span>
        {isOpen ? <ChevronUp className="h-4 w-4" /> : <ChevronDown className="h-4 w-4" />}
      </Button>
      {isOpen && (
        <div className="mt-0 p-4 border border-t-0 rounded-b-md bg-white text-sm">
          {children}
        </div>
      )}
    </div>
...
const TriTestReport: React.FC = () => {
  ...
  return (
    <div className="max-w-4xl mx-auto my-8 font-['Inter'] bg-gray-50">
      <div className="bg-white rounded-lg shadow-lg overflow-hidden border">
        {/* Header */}
        <header className="bg-white p-6 text-center border-b">
          ...
          <h1 className="text-3xl lg:text-4xl font-light text-blue-800 mb-2 tracking-tight">
            Your Myant Heart & Health Insights
          </h1>
        ...
        {/* View Toggle */}
        <div className="flex justify-center bg-gray-50 p-3 border-b">
          <Button
        ...
        <div className="p-6">
          ...
          <Card className="mb-6 bg-gray-50 border-l-4 border-l-blue-500">
            <CardContent className="p-4">
              <h4 className="font-semibold text-blue-800 mb-3">Result Indicators</h4>
              <div className="flex flex-wrap gap-6 text-sm">
                ...
                <div className="flex items-center">
                  <div className="w-3 h-3 bg-red-500 rounded mr-2 border"></div>
            ...
            <div>
              ...
              <Card className="mb-8">
                <CardContent className="p-6">
                  <h2 className="text-2xl font-semibold text-blue-800 mb-4 pb-2 border-b">
                    Your Health Summary
                  </h2>
                  ...
                  <div className="mb-6">
                    ...
                    <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-4">
                      <Card className="p-4 bg-gray-50">
                        <div className="font-semibold text-blue-800 mb-2">Heart Rhythm</div>
                        <div className="flex items-start">
                          <div className="w-3 h-3 bg-red-500 rounded mr-3 mt-1 flex-shrink-0"></div>
                      ...
                      <Card className="p-4 bg-gray-50">
                        <div className="font-semibold text-blue-800 mb-2">Blood Pressure</div>
                        <div className="flex items-start">
                          <div className="w-3 h-3 bg-red-500 rounded mr-3 mt-1 flex-shrink-0"></div>
                          <div className="text-sm text-gray-600">
                      ...
                      <Card className="p-4 bg-gray-50">
                        <div className="font-semibold text-blue-800 mb-2">Sleep Quality</div>
                        <div className="flex items-start">
                  ...
                  <Card className="p-4 bg-gray-100">
                    <h3 className="text-lg font-semibold text-blue-800 mb-3">Recommended Next Steps</h3>
                    <ol className="space-y-3 text-sm">
                      <li className="flex items-start">
                        <div className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-semibold mr-3 flex-shrink-0 mt-0.5">
                          1
                        </div>
              ...
              {/* Detailed Results */}
              <div>
                <h2 className="text-2xl font-semibold text-blue-800 mb-6">Detailed Results (Patient View)</h2>

                {/* ECG Module */}
                <Card className="mb-8">
                  <CardContent className="p-6">
                    <h3 className="text-xl font-semibold text-gray-900 mb-4 pb-2 border-b flex items-center">
                      ...
                      <div>
                        ...
                        <Card className="mt-4 p-4 bg-gray-100">
                          <p className="text-sm mb-2">
                            <strong className="text-blue-800">What This Means:</strong> Mostly normal rhythm, 
                            but episodes of Atrial Fibrillation were detected, matching your symptoms.
                          </p>
                          <p className="text-sm text-gray-600">
                            <strong className="text-blue-800">Guidance:</strong> AFib needs medical evaluation. 
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <Card className="mt-4 p-4 bg-gray-100">
                          <p className="text-sm mb-2">
                            <strong className="text-blue-800">What This Means:</strong> Your average BP is mildly elevated. 
                            It didn't drop enough during sleep (non-dipper pattern), and your arteries show some stiffness.
                          </p>
                          <p className="text-sm text-gray-600">
                            <strong className="text-blue-800">Guidance:</strong> Consider lifestyle changes: 
                  ...
                  <CardContent className="p-6">
                    ...
                    <div className="grid lg:grid-cols-2 gap-6">
                      ...
                      <div>
                        ...
                        <Card className="mt-4 p-4 bg-gray-100">
                          <p className="text-sm mb-2">
                            <strong className="text-blue-800">What This Means:</strong> Findings suggest mild obstructive 
                            sleep apnea (OSA), with breathing interrupted ~12 times/hour.
                          </p>
                          <p className="text-sm text-gray-600">
                            <strong className="text-blue-800">Guidance:</strong> Consider weight loss (if needed), 
            ...
            <div>
              ...
              <Card className="mb-8">
                <CardContent className="p-6">
                  ...
                  <div className="mb-6">
                    <h3 className="text-lg font-semibold text-gray-900 mb-4">Key Clinical Findings</h3>
                    <div className="grid md:grid-cols-1 lg:grid-cols-3 gap-4">
                      <Card className="p-4 bg-gray-50">
                        <div className="font-semibold text-blue-800 mb-2">Cardiac</div>
                        <div className="flex items-start">
                          <div className="w-3 h-3 bg-red-500 rounded mr-3 mt-1 flex-shrink-0"></div>
                          <div className="text-sm text-gray-600">
                      ...
                      <Card className="p-4 bg-gray-50">
                        <div className="font-semibold text-blue-800 mb-2">Hemodynamic</div>
                        <div className="flex items-start">
                          <div className="w-3 h-3 bg-red-500 rounded mr-3 mt-1 flex-shrink-0"></div>
                          <div className="text-sm text-gray-600">
                      ...
                      <Card className="p-4 bg-gray-50">
                        <div className="font-semibold text-blue-800 mb-2">Sleep</div>
                        <div className="flex items-start">
                          <div className="w-3 h-3 bg-yellow-500 rounded mr-3 mt-1 flex-shrink-0"></div>
                          <div className="text-sm text-gray-600">
                  ...
                  <Card className="p-4 bg-gray-100">
                    <h3 className="text-lg font-semibold text-blue-800 mb-3">Clinical Recommendations</h3>
                    <ol className="space-y-3 text-sm">
                      <li className="flex items-start">
                        <div className="w-6 h-6 bg-blue-500 text-white rounded-full flex items-center justify-center text-xs font-semibold mr-3 flex-shrink-0 mt-0.5">
                          1
              ...
              <div>
                <h2 className="text-2xl font-semibold text-blue-800 mb-6">Detailed Clinical Results</h2>
                            ...
                            <tbody>
                              <tr className="border-b">
                                ...
                                <td className="px-3 py-2 text-center">
                                  <div className="w-3 h-3 bg-red-500 rounded mx-auto"></div>
                                </td>
                              </tr>
                              <tr className="border-b bg-gray-50">
        ...
        <footer className="bg-gray-50 p-6 text-center border-t text-sm">
          <div className="max-w-2xl mx-auto mb-4 text-gray-600 leading-relaxed">
            <strong className="text-red-700">Important:</strong> This report summarizes collected data and is{' '}
