...
const HeroSection = () => {
  ...
  return (
    <div className="pt-28 pb-16 md:pt-32 md:pb-24 gradient-soft">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-2">
              <Badge variant="outline" className="bg-white/80 backdrop-blur-sm border-primary/30">
                <Shield className="w-4 h-4 mr-2 text-primary" />
                {language === 'en' ? 'CE Medical Device' : language === 'fr' ? 'Dispositif Médical CE' : 'CE Medizinprodukt'}
              </Badge>
              <Badge variant="outline" className="bg-white/80 backdrop-blur-sm border-medical-teal/30">
                <Heart className="w-4 h-4 mr-2 text-medical-teal" />
            ...
            <div className="flex flex-col sm:flex-row gap-4">
              <Button size="lg" className="gradient-primary border-0 text-white px-8 hover:opacity-90 transition-opacity">
          ...
          <div className="relative animate-slide-in">
            ...
            <Card className="absolute -top-4 -left-4 bg-white shadow-lg border-primary/20">
            ...
            <Card className="absolute -bottom-4 -right-4 bg-white shadow-lg border-medical-teal/20">
              <CardContent className="p-4 text-center">
                <div className="text-2xl font-bold text-medical-teal">7x</div>
                <div className="text-xs text-muted-foreground">
            ...
            {/* Background Gradient */}
            <div className="absolute inset-0 bg-gradient-to-br from-primary/10 to-medical-teal/5 rounded-2xl -z-10"></div>
          </div>
        </div>
