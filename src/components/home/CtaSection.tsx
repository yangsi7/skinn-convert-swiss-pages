              ...
              <div className="flex items-center space-x-2">
                <div className="bg-white rounded-full p-1">
                  <svg width="16" height="16" viewBox="0 0 16 16" fill="none">
                    <path d="M14 6.5L10 10.5L8 8.5L2 14.5" stroke="hsl(174 60% 35%)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                    <path d="M14 10.5V6.5H10" stroke="hsl(174 60% 35%)" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                  </svg>
                </div>
